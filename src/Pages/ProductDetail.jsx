      ...
      <div className="max-w-[95%] xl:max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16">
          ...
          <div className="space-y-4">
            {/* Main Image */}
            <div 
              className="relative aspect-square rounded-2xl overflow-hidden bg-gray-100 cursor-zoom-in shadow-lg"
              ...
              <div className="flex items-baseline gap-4 flex-wrap">
                ...
                {product.sale_price && (
                  <>
                    ...
                    <span className="px-4 py-2 bg-rose-100 text-rose-600 font-semibold rounded-full text-sm">
