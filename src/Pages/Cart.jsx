    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-[95%] xl:max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        <motion.h1 
          ...
          className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 lg:mb-10"
        >
            ...
            <AnimatePresence>
              {cart.map((item, index) => (
                <motion.div
                  ...
                  className="bg-white p-5 lg:p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-200 flex gap-4 lg:gap-6"
                >
                  {/* Product Image */}
                  <Link 
